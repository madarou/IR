...
@author: makao
将final_user_intr_1.txt根据tag_group.txt中的标签分组重新整合，
...
if __name__ == '__main__':
    ...
    tag_group_dict = {}
    line_counter = 0
    ff = open('/Users/makao/Yun/Workspace/lab/data/java_relation/intrcom-compare/tag_interest_merge2_compare.txt','w')
    ...
    f = open('/Users/makao/Yun/Workspace/lab/data/java_relation/intrcom-compare/final_user_intr_merged_2_compare.txt','w')
    for line in open('/Users/makao/Yun/Workspace/lab/data/java_relation/intrcom-compare/final_user_intr_1.txt'):
