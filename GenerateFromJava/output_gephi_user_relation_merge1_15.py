...
#         user_similarity.append(user_i_list)
    ...
    for line in open('/Users/makao/Yun/Workspace/lab/data/java_relation/final_user_intr_merged_1.txt'):
        uname = line.split('|')[0].strip()
    ...
    ftagcolor = open('/Users/makao/Yun/Workspace/lab/data/java_relation/visual/tag-interest-color_merge1.txt','w')
    for line in open('/Users/makao/Yun/Workspace/lab/data/java_relation/tag_interest_merge1.txt'):
    #for i in range(0, 234):
        ...
        tag_color_number_list.append(tag_color_value*1000)
        print >> ftagcolor, '%s %s %d' % (tag_number,tag_name,tag_color_value*1000)
    ftagcolor.close()
    #写点到文件
    ff = open('/Users/makao/Yun/Workspace/lab/data/java_relation/visual/num_nodes_gephi_merge1.csv','w')
    ...
    #写边到文件
    fff = open('/Users/makao/Yun/Workspace/lab/data/java_relation/visual/num_edges_gephi_merge1.csv','w')
