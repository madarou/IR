...
if __name__ == '__main__':
    ...
    tag_group_dict = {}
    line_counter = 0
    for line in open('/Users/makao/Yun/Workspace/lab/data/java_relation/tag-group.txt'):
        tags = line.split()
        for t in tags:
    ...
    for (key,value) in tag_group_dict.items():
        print key, value
    f = open('/Users/makao/Yun/Workspace/lab/data/java_relation/final_user_intr_merged.txt','w')
