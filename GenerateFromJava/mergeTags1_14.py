...
if __name__ == '__main__':
    ...
    tag_group_dict = {}
    line_counter = 0
    ff = open('/Users/makao/Yun/Workspace/lab/data/java_relation/tag_interest_merge1.txt','w')
    for line in open('/Users/makao/Yun/Workspace/lab/data/java_relation/tag-group1.txt'):
        tags = line.split()
        for t in tags:
    ...
    f = open('/Users/makao/Yun/Workspace/lab/data/java_relation/final_user_intr_merged_1.txt','w')
