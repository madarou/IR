...
if __name__ == '__main__':
    ...
    f = open('/Users/makao/Yun/Workspace/lab/data/java_relation/ti.txt','w')
    for item in user_relation_list:
        if item == 'no-item':
            continue
        print >> f, '%s' % calculateTi(item,user_relation_list,user_interest_list)
    f.close()