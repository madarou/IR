...
#         user_similarity.append(user_i_list)
    ...
    for line in open('/Users/makao/Yun/Workspace/lab/data/java_relation/final_user_intr_merged_2.txt'):
        uname = line.split('|')[0].strip()
    ...
    ftagcolor = open('/Users/makao/Yun/Workspace/lab/data/java_relation/visual/tag-interest-color_merge2.txt','w')
    for line in open('/Users/makao/Yun/Workspace/lab/data/java_relation/tag_interest_merge2.txt'):
    ...
    ftagcolor.close()
    #写点到文件
    ff = open('/Users/makao/Yun/Workspace/lab/data/java_relation/visual/num_nodes_gephi_merge2.csv','w')
    ...
    #写边到文件
    fff = open('/Users/makao/Yun/Workspace/lab/data/java_relation/visual/num_edges_gephi_merge2.csv','w')
