...
#         user_similarity.append(user_i_list)
    ...
    ftagcolor = open('/Users/makao/Yun/Workspace/lab/data/java_relation/visual/tag-interest-color.txt','w')
    ...
    ftagcolor.close()
    #写点到文件
    ff = open('/Users/makao/Yun/Workspace/lab/data/java_relation/visual/num_nodes_gephi.csv','w')
    ...
    #写边到文件
    fff = open('/Users/makao/Yun/Workspace/lab/data/java_relation/visual/num_edges_gephi.csv','w')
